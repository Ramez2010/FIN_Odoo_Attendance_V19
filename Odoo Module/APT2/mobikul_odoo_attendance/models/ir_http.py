...
class Http(models.AbstractModel):
    ...
    def binary_content(self, xmlid=None, model='ir.attachment', id=None, field='datas',
        ...
        if obj and obj._name == "res.partner" and field in ("image_1920", "profile_banner", "profile_image", "banner_image"):
            self = self.sudo()
        if obj and obj._name == "hr.employee" and field in ("image_1920", "profile_banner", "profile_image", "banner_image"):
            self = self.sudo()
        if obj and obj._name == "mobikul.attendance.messages" and field in ("icon", "banner"):
            self = self.sudo()
